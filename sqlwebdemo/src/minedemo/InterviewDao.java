  ...
  public boolean updateDept(Interview viewData) {
    try {
      String sqlString = "UPDATE interview " +
	                  	   	 ...
	                  	   	 ", int_Time = '" + viewData.getInt_Time() +"' "+ 
	                  	   	 ", comp_Name = '" + viewData.getComp_Name() +"' "+ 
	                  	   	 ", job_Name = '" + viewData.getJob_Name() +"' "+ 
	                  	   	 ", offer = '" + viewData.getOffer() +"' "+ 
	                  	   	 ", test = '" + viewData.getTest() +"' "+ 
	                  	   	 ", language = '" + viewData.getLanguage() +"' "+ 
	                  	   	 ", qA = '" + viewData.getQA() +"' "+ 
	                  	   	 ", share = '" + viewData.getShare() +"' "+ 
	                  	   	 ", int_Score = '" + viewData.getInt_Score() +"' "+ 
	                  	   	 ", comp_Score = '" + viewData.getInt_Score() +"' "+ 
	                  	   	 ", user_id = '" + viewData.getUSER_ID() +"' "+ 
...
//	                  	   	 "SET user_id = '" + viewData.getUSER_ID() +"' "+ 
    		  
                    			 "WHERE cv_no = " + viewData.getCv_No();
  ...
  public Interview selectByCv_No(int cv_No) {
      try {
        ...
        String comp_Name ;
         String Job_Name;
    	  ...
    	  String sql = "select * from Interview where CV_NO = "+cv_No;
          ...
          if (rs.next()) {
      		...
      		interview = new Interview(cv_No, Created_Time, Int_Time, comp_Name, Job_Name, Offer, Test, Language, QA, Share, Int_Score, Comp_Score, USER_ID);
      	  }rs.close();
    	  statement.close();
    	  return interview;
